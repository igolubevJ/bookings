...
import (
	...
	"github.com/igolubevJ/bookings/internal/forms"
...
// Post Reservation handlers the posting of a reservation form
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	content := fmt.Sprintf("start date is %s and end date is %s", start, end)
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.ErrorLog.Println(w, "cannot get error from session")
